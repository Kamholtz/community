...
(debug | debugger) step into: user.vscode("workbench.action.debug.stepInto")
(debug | debugger) step out [of]: user.vscode("workbench.action.debug.stepOut")
(debug | debugger) start: user.vscode("workbench.action.debug.start")
(debug | debugger) select: user.vscode("workbench.action.debug.selectandstart")
(debug | debugger) pause: user.vscode("workbench.action.debug.pause")
(debug | debugger) stopper: user.vscode("workbench.action.debug.stop")
(debug | debugger) continue: user.vscode("workbench.action.debug.continue")
(debug | debugger) restart: user.vscode("workbench.action.debug.restart")
