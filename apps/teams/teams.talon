...
# chat navigation
see unread (chats | activity): key(ctrl-alt-u)
jump [to] (last read | latest) message: key(ctrl-j)
reply last message: key(alt-shift-r)
react last message: key(ctrl-alt-r)
